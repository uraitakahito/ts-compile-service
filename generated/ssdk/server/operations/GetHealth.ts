...
import { GetHealthOutput } from "../../models/models_0";
import {
  deserializeGetHealthRequest,
  serializeFrameworkException,
  serializeGetHealthResponse,
  serializeValidationExceptionError,
} from "../../protocols/Aws_restJson1";
import { TsCompileService } from "../TsCompileService";

export type GetHealth<Context> = __Operation<GetHealthServerInput, GetHealthServerOutput, Context>

export interface GetHealthServerInput {}
export namespace GetHealthServerInput {
  /**
   * @internal
   */
  export const validate: () => __ValidationFailure[] = () => [];
}
export interface GetHealthServerOutput extends GetHealthOutput {}

export type GetHealthErrors = ValidationException

export class GetHealthSerializer implements __OperationSerializer<TsCompileService<any>, "GetHealth", GetHealthErrors> {
  serialize = serializeGetHealthResponse;
  deserialize = deserializeGetHealthRequest;

  isOperationError(error: any): error is GetHealthErrors {
    const names: GetHealthErrors['name'][] = ["ValidationException"];
    return names.includes(error.name);
  };

  serializeError(error: GetHealthErrors, ctx: ServerSerdeContext): Promise<__HttpResponse> {
    switch (error.name) {
...
export const getGetHealthHandler = <Context>(operation: __Operation<GetHealthServerInput, GetHealthServerOutput, Context>): __ServiceHandler<Context, __HttpRequest, __HttpResponse> => {
  const mux = new httpbinding.HttpBindingMux<"TsCompile", "GetHealth">([
  ...
  const customizer: __ValidationCustomizer<"GetHealth"> = (ctx, failures) => {
    if (!failures) {
      return undefined;
    }
    return {
  ...
  return new GetHealthHandler(operation, mux, new GetHealthSerializer(), serializeFrameworkException, customizer);
}
...
export class GetHealthHandler<Context> implements __ServiceHandler<Context> {
  private readonly mux: __Mux<"TsCompile", "GetHealth">;
  private readonly operation: __Operation<GetHealthServerInput, GetHealthServerOutput, Context>;
  private readonly serializer: __OperationSerializer<TsCompileService<Context>, "GetHealth", GetHealthErrors>;
  private readonly serializeFrameworkException: (e: __SmithyFrameworkException, ctx: __ServerSerdeContext) => Promise<__HttpResponse>;
  private readonly validationCustomizer: __ValidationCustomizer<"GetHealth">;
  ...
  /**
   * Construct a GetHealth handler.
   * @param operation The {@link __Operation} implementation that supplies the business logic for GetHealth
   * @param mux The {@link __Mux} that verifies which service and operation are being invoked by a given {@link __HttpRequest}
   * @param serializer An {@link __OperationSerializer} for GetHealth that
   *                   handles deserialization of requests and serialization of responses
   * @param serializeFrameworkException A function that can serialize {@link __SmithyFrameworkException}s
   * @param validationCustomizer A {@link __ValidationCustomizer} for turning validation failures into {@link __SmithyFrameworkException}s
   */
  constructor(
    operation: __Operation<GetHealthServerInput, GetHealthServerOutput, Context>,
    mux: __Mux<"TsCompile", "GetHealth">,
    serializer: __OperationSerializer<TsCompileService<Context>, "GetHealth", GetHealthErrors>,
    serializeFrameworkException: (e: __SmithyFrameworkException, ctx: __ServerSerdeContext) => Promise<__HttpResponse>,
    validationCustomizer: __ValidationCustomizer<"GetHealth">
  ) {
  ...
  async handle(request: __HttpRequest, context: Context): Promise<__HttpResponse> {
    ...
    const steps: __FrameworkSteps<Context> = {
      route: (request) => this.mux.match(request) !== undefined ? "GetHealth" : undefined,
      ...
      validate: (_op, input) => timedSync("ValidationTime", () => {
        const validationFailures = (GetHealthServerInput.validate as (input: any) => __ValidationFailure[])(input);
        if (validationFailures && validationFailures.length > 0) {
          const validationException = this.validationCustomizer({ operation: "GetHealth" }, validationFailures);
          if (validationException) {
            throw validationException;
          }
        }
      }),
      invoke: (_op, input, context) => timed("ActivityTime", () => this.operation(input as GetHealthServerInput, context)),
      serialize: (_op, output) => timed("SerializationTime", () => this.serializer.serialize(output as GetHealthServerOutput, serdeContextBase)),
